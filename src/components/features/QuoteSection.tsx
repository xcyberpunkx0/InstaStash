  ...
  return (
    <section className="max-w-[1280px] mx-auto px-6 md:px-12 py-[60px] md:py-[100px] text-center">
      <div className="max-w-[760px] mx-auto">
        ...
        <blockquote className="font-display font-medium italic text-[clamp(28px,4vw,42px)] leading-[1.18] text-(--color-ink-900) m-0 text-balance">
        ...
        <div className="mt-[22px] font-hand text-h3 text-(--color-ink-500)">
          — maya k., illustrator
        </div>
      </div>
    </section>

...
export function DownloadCTA() {
  return (
    <section id="download" className="max-w-[1280px] mx-auto px-6 md:px-12 pb-20">
      <div className="relative overflow-hidden px-8 md:px-12 py-14 bg-(--color-ink-900) text-(--color-paper-50) rounded-[32px]">
        {/* Terra glow */}
        ...
        <div className="relative flex justify-between items-center gap-10 flex-wrap">
          <div>
            <span className="font-hand text-[24px] text-[#D7906A]">
              it&rsquo;s free, by the way —
            </span>
            <h2 className="font-display font-medium italic text-[clamp(36px,5vw,48px)] leading-[1.05] text-(--color-paper-50) max-w-[12ch] mt-1 m-0">
              Take it for a walk.
            </h2>
          </div>

          <div className="flex gap-3 flex-wrap">
            <a href="#" className="inline-flex items-center gap-2.5 px-[22px] py-3.5 bg-(--color-paper-50) text-(--color-ink-900) rounded-pill no-underline font-grotesk font-semibold text-[15px] hover:translate-y-[-1px] transition-transform duration-[160ms]">
            ...
            <a href="#" className="inline-flex items-center gap-2.5 px-[22px] py-3.5 bg-transparent text-(--color-paper-50) border-[1.5px] border-[rgba(247,243,238,0.4)] rounded-pill no-underline font-grotesk font-semibold text-[15px] hover:translate-y-[-1px] transition-transform duration-[160ms]">

...
export function Footer() {
  return (
    ...
    >
      ...
      <div className="mt-10 pt-[18px] flex justify-between items-center font-[family-name:var(--font-hand)] text-[var(--color-ink-400)] text-[18px]">
        <span>© 2026 · made by friends</span>

    ...
    return (
      <div className="flex flex-col items-center gap-3 py-6" data-testid="download-progress-complete">
        <div className="w-16 h-16 rounded-full bg-sage-200 flex items-center justify-center">
          <svg className="w-8 h-8 text-sage-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <path d="M20 6 9 17l-5-5" />
          </svg>
        </div>
        <p className="font-hand text-[26px] text-sage-600">
          Download complete ✦
        </p>
      </div>
    );
    ...
    return (
      <div className="flex flex-col items-center gap-3 py-6" data-testid="download-progress-error">
        <div className="w-12 h-12 rounded-full bg-[#F2D5D2] flex items-center justify-center">
          <svg className="w-5 h-5 text-rouge-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <circle cx="12" cy="12" r="10" />
            <line x1="15" y1="9" x2="9" y2="15" />
            <line x1="9" y1="9" x2="15" y2="15" />
          </svg>
        </div>
        <p className="text-[15px] text-rouge-500">Something went wrong during download.</p>
        {onRetry && (
  ...
  return (
    <div className="w-full flex flex-col gap-2" data-testid="download-progress-downloading" role="region" aria-label="Download progress">
      <div className="flex justify-between items-center">
        <span className="text-small text-(--color-ink-500)">Downloading...</span>
        <span className="font-mono text-small text-(--color-ink-900)">
          {clamped}%
        </span>
      </div>
